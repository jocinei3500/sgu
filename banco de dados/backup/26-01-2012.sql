...
INSERT INTO `marca` (`COD_MARCA`,`MARCA`,`FABRICANTE`) VALUES 
 (146,'Tramontina',NULL),
 (147,'Most Felling',NULL),
 (148,'minipa',NULL),
 (149,'Robust',NULL),
 (150,'Robust',NULL),
 (151,'Vonder',NULL),
 (152,'Starret',NULL),
 (153,'Gedore Vanadium',NULL),
 (154,'Gedore Vanadium',NULL),
 (155,'Gedore Vanadium',NULL),
 (156,'Gedore Vanadium',NULL),
 (157,'Gedore Vanadium',NULL),
 (158,'Gedore Vanadium',NULL),
 (159,'Gedore Vanadium',NULL),
 (160,'Hikari Plus',NULL),
 (161,'Cobix',NULL),
 (162,'EBERLE',NULL),
 (163,'WEG',NULL),
 (164,'WEG',NULL),
...
INSERT INTO `produto` (`COD_PROD`,`DESCRICAO`,`MARCA`,`COD_SERIE`,`UNIDADE`,`valor`) VALUES 
 ...
 (146,'alicate universal','146',NULL,NULL,NULL),
 (147,'alicate universal','147','a1171088',NULL,NULL),
 (148,'multímetro','148','PEAK HOLD ET 3200A',NULL,NULL),
 (149,'alicate de bico','149','835-8',NULL,NULL),
 (150,'alicate de corte','150','815-200',NULL,NULL),
 (151,'alicate prensa-terminal','151','AP-055',NULL,NULL),
 (152,'estilete','152','s-05',NULL,NULL),
 (153,'chave de fenda','153','1/2\"x10\"',NULL,NULL),
 (154,'chave de fenda','154','150-19 8x150mm',NULL,NULL),
 (155,'chave de fenda','155','3/8\"x6\"',NULL,NULL),
 (156,'chave de fenda','156','150 1/4\"x6\"',NULL,NULL),
 (157,'chave philips','157','3/16\"x6\" 160 ph1',NULL,NULL),
 (158,'chave de fenda','158','150 1/8\"x4\"',NULL,NULL),
 (159,'chave philips','159','1/4\"x4\" ph2',NULL,NULL),
 (160,'aparelho de solda-estanho','160','SC 40, 220V AC, 400W',NULL,NULL),
 (161,'solda estanho','161','40x60c',NULL,NULL),
 (162,'motor trifásico','162','220/380V AC, 60 CV, 1775 rpm',NULL,NULL),
 (163,'motor trifásico','163','220/380V AC, 40 CV, 1100 rpm',NULL,NULL),
 (164,'motor trifásico','164','220/380V AC, 7,5 CV',NULL,NULL),
 (165,'motor trifásico','165','220/380V AC, 7,5 CV, 1745 rpm',NULL,NULL),
 (166,'motor trifásico',NULL,'220/380V AC, 1 CV',NULL,NULL),
 (167,'motor trifásico','167','220/380V AC, 10 CV',NULL,NULL),
 (168,'motor trifásico','168','C711, 220/380V AC, 15CV, 1160 rpm',NULL,NULL),
 (169,'contator  trifásico','169','220 V AC, 50 A',NULL,NULL),
 (170,'contator  trifásico','170','220V AC, 50 A',NULL,NULL),
 (171,'contator  trifásico','171','3TB50, 220V AC, 150A',NULL,NULL),
 (172,'contator  trifásico','172','CWM32, 220V AC',NULL,NULL),
 (173,'contator  trifásico','173','3TF44, 220V AC, 50A',NULL,NULL),
 (174,'Interfase IHM Toush Screen','174','KTP600, 24V DC',NULL,NULL),
 (175,'ventilador de painél elétrico','175','E11NYCD, 127/220V AC, 23/15W',NULL,NULL),
 (176,'Transformador','176','MV1000, 110/220V AC',NULL,NULL),
 (177,'disjuntor monofásico','177','C20, 220/380V AC, 20 A',NULL,NULL),
 (178,'chave liga/desliga bifásica','178','380V AC, 7,5 CV',NULL,NULL),
 (179,'horímetro digital','179','ET49V3, 110/220V AC',NULL,NULL),
 (180,'relé fotoelétrico','180','NRF2F2, 220V AC, 1000W',NULL,NULL),
 (181,'transformador de corrente','181','HEB603, 400/5 A',NULL,NULL),
 (182,'disjuntor bifásico','182','K32A, 220/380V AC, 32A',NULL,NULL),
 (183,'prensa cabo','183','BSP 1,1/2\"',NULL,NULL),
 (184,'bobina p válvula pneumática','184','220 5VA, 220V AC',NULL,NULL),
 (185,'tomada trifásica','185','30A  500V AC, 30A',NULL,NULL),
 (186,'Reator p sódio v. metálico','186','VSTE 400, 220V AC, 400W',NULL,NULL),
 (187,'Reator p sódio v. metálico','187','400w, 220V AC',NULL,NULL),
 (188,'Sensor PNP NPN',NULL,'FAE 25S, 110/220V AC',NULL,NULL),
 (189,'relé de sobrecarga','189','JR28-3357, 220V AC, 37-50A',NULL,NULL),
 (190,'relé de sobrecarga','190','G/040120, 220V AC, 14-20A',NULL,NULL),
 (191,'relé de sobrecarga','191','RW 67-2D, 220V AC, 40-57A',NULL,NULL),
 (192,'relé de sobrecarga','192','LRD33, 220V AC, 37-50A',NULL,NULL),
 (193,'relé de sobrecarga','193','3UA58, 220V AC, 50-63A',NULL,NULL),
 (194,'relé de sobrecarga','194','3UA52,220V AC, 16-25A',NULL,NULL),
 (195,'relé de sobrecarga','195','3UA55, 220V AC, 20-32A',NULL,NULL),
 (196,'contato ch. compensadora',NULL,NULL,NULL,NULL),
 (197,'barramento ch compesadora',NULL,NULL,NULL,NULL),
 (198,'chave trifásica mecânica','198','CA10 A202600-E, 380V, 4A',NULL,NULL),
 (199,'jogo de contato contator trif.','199','3TB50',NULL,NULL),
 (200,'PT 100 (COM DEFEITO)','200','24V DC, 0-250°C',NULL,NULL),
 (201,'PT 100 (COM DEFEITO)','201','24V DC, 0-250°C',NULL,NULL),
 (202,'amp. Movimot SEW','202','MWA 21A',NULL,NULL),
 (203,'amp. Movimot SEW(DEFEITO)','203','MWA 21A',NULL,NULL),
 ...
 (237,'rolamento 11255','237','11265','peça',0);
